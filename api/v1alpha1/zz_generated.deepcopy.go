...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SynkTarget) DeepCopyInto(out *SynkTarget) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SynkTarget.
func (in *SynkTarget) DeepCopy() *SynkTarget {
	if in == nil {
		return nil
	}
	out := new(SynkTarget)
...
// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SynkTarget) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SynkTargetList) DeepCopyInto(out *SynkTargetList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]SynkTarget, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SynkTargetList.
func (in *SynkTargetList) DeepCopy() *SynkTargetList {
	if in == nil {
		return nil
	}
	out := new(SynkTargetList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *SynkTargetList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SynkTargetSpec) DeepCopyInto(out *SynkTargetSpec) {
	*out = *in
	if in.Connection != nil {
		in, out := &in.Connection, &out.Connection
		*out = new(Connection)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SynkTargetSpec.
func (in *SynkTargetSpec) DeepCopy() *SynkTargetSpec {
	if in == nil {
		return nil
	}
	out := new(SynkTargetSpec)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *SynkTargetStatus) DeepCopyInto(out *SynkTargetStatus) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new SynkTargetStatus.
func (in *SynkTargetStatus) DeepCopy() *SynkTargetStatus {
	if in == nil {
		return nil
	}
	out := new(SynkTargetStatus)
	in.DeepCopyInto(out)
	return out
}
